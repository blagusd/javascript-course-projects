...
const account3 = {
  ...
  pin: 3333,
  movementsDates: [
    '2019-08-01T03:15:33.035Z',
    '2019-10-30T02:48:16.867Z',
    '2019-12-25T04:04:23.907Z',
    '2020-01-25T14:18:46.235Z',
    '2020-03-06T16:33:06.386Z',
    '2020-04-11T14:43:26.374Z',
    '2020-05-28T18:49:59.371Z',
    '2020-07-29T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const account4 = {
  ...
  movementsDates: [
    ...
    '2019-10-23T07:42:02.384Z',
    '2020-02-28T08:15:04.904Z',
    '2020-04-01T10:17:24.185Z',
    '2020-05-08T14:11:59.604Z',
  ],
  currency: 'EUR',
...
// Calculate days passed from movement
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    // Setting up dates: day/month/year
    const now = new Date();
    const day = `${now.getDate()}`.padStart(2, 0);
    const month = `${now.getMonth()}`.padStart(2, 0);
    const year = now.getFullYear();
    const hour = `${now.getHours()}`.padStart(2, 0);
    const min = `${now.getMinutes()}`.padStart();
